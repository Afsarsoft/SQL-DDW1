CREATE OR ALTER PROCEDURE ddw1DW.BuildDimTime
    @MinDate DATE,
    @MaxDate DATE
AS
/***************************************************************************************************
...
----------------------------------------------------------------------------------------------------
Procedure:      ddw1DW.BuildDimTime
Create Date:    2021-03-01 (yyyy-mm-dd)
Author:         Surush Cyrus
Description:    Build table ddw1DW.DimTime  
Call by:        TBD, UI, Add hoc
Steps:          NA
Parameter(s):   None
Usage:          EXEC ddw1DW.BuildDimTime @MinDate = '1/1/2020',
                                        @MaxDate = '1/31/2022';
****************************************************************************************************
SUMMARY OF CHANGES
...
-------------------------------------------------------------------------------
SET @ErrorText = 'Failed Build Table ddw1DW.DimTime.';

-- Delete contents of Date Dimension Table
TRUNCATE TABLE ddw1DW.DimTime;
...
SET @Message = 'Completed Build Table ddw1DW.DimTime.';
